...
//++++rgk disable for true ps value in cit by anxiang.xiao 20140321
#define STK_TUNE0
//+++end
...
#if (defined(MT6589) || defined(MT6572) || defined(MT6582) || defined(MT6577) || defined(MT6575) || defined(MT6592))
...
#endif
{
	...
	switch (cmd)
	{
		...
		case ALSPS_GET_PS_TEST_RESULT:
			...
			//+++rgk anxiang.xiao change for cit pass normally 20140423 
			#if 0
