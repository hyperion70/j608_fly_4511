...
#define APDS9960_PDRVIE_FOR_PS		APDS9960_PDRIVE_50mA  //APDS9960_PDRIVE_100mA
...
#define APDS9960_GPULSE		12	// kk 27-Nov-2013, 10
#define APDS9960_GPULSE_LEN	APDS9960_PULSE_LEN_16US	// kk 27-Nov-2013, APDS9960_PULSE_LEN_32US	
...
#define	APDS9960_GESTURE_LED_BOOST	APDS9960_LED_BOOST_150	// kk 19-Nov-2013, 300

#define APDS9960_PS_DETECTION_THRESHOLD	150  //250  //150 //50
#define APDS9960_PS_HSYTERESIS_THRESHOLD	100 //240 //100 //30
...
#define GESTURE_SENSITIVITY_LEVEL1	20	// kk 19-Nov-2013, 50
#define GESTURE_SENSITIVITY_LEVEL2	10	// kk 19-Nov-2013, 20

#define	GESTURE_GTHR_IN		80	// kk 27-Nov-2013, 40
#define GESTURE_GTHR_OUT		60	// kk 27-Nov-2013, 30	
...
struct apds9960_data {
	...
	struct alsps_cal cal;  //[jing.zhao@qingcheng.com]
    int irq;
	int suspended;	
	...
	int als_level_num;
    int als_value_num;
    int als_level[C_CUST_ALS_LEVEL-1];
    int als_value[C_CUST_ALS_LEVEL];
	ulong       apds_enable;
