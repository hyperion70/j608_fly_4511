...
#define MIN_VOLTAGE (1100)     // zhoulidong  add for lcm detect
#define MAX_VOLTAGE (1300)     // zhoulidong  add for lcm detect
...
static LCM_setting_table_V3 lcm_initialization_setting[] = {
	...
	*/
	...
	{0x15,0x30,1,{0x01}},        //Resolution setting 480 X 800 
	{0x15,0x31,1,{0x02}},        //Inversion setting 2-dot 
	{0x15,0x40,1,{0x14}},       //BT  
	{0x15,0x41,1,{0x33}},        //Default 
	{0x15,0x42,1,{0x03}},         //    
	{0x15,0x43,1,{0x09}},        //Default 
	{0x15,0x44,1,{0x07}}, 
	{0x15,0x45,1,{0x16}},
	{0x15,0x46,1,{0x44}},  
	{0x15,0x47,1,{0x44}}, 
	{0x15,0x50,1,{0x78}},        //VREG1 
	{0x15,0x51, 1,{0x78}},        //VREG2  
	{0x15,0x52,1,{0x00}},        //Flicker MSB 
	{0x15,0x53,1,{0x8A}},        //Flicker LSB 
	{0x15,0x60,1,{0x07}},        // 
	{0x15,0x61,1,{0x00}},         //  
	{0x15,0x62,1,{0x08}},        // 
	{0x15,0x63,1,{0x00}},        //  
	...
	{0x15,0xAE,1,{0x0C}},        // 
	{0x15,0xAF,1,{0x00}},         // 
	{0x15,0xC0,1,{ 0x00}},        //Negative Gamma   
	{0x15,0xC1,1,{0x0A}},        // 
	{0x15,0xC2,1,{0x10}},        //  
	{0x15,0xC3,1,{0x0C}},        // 
	{0x15,0xC4,1,{0x04}},         // 
	...
	{0x15,0x40,1,{0x22}}, 
	{0x15,0x52,1,{0x10}},
	{0x39,0xFF,5,{0xFF,0x98,0x06,0x04,0x07}},         // Change to Page 7 CMD for Normal command 
	{0x15,0x18,1,{0x1D}}, 
	{0x15,0x17,1,{0x22}}, 
	{0x15,0x02,1,{0x77}}, 
	{0x15,0x06,1,{0x13}}, 
...
static unsigned int lcm_esd_recover(void)
{
	...
	#ifndef BUILD_LK
	printk("lcm_esd_recover  ili9806e_dsi_vdo_hlt_fwvga_oncell \n");
	#endif
	return TRUE;
}
...
LCM_DRIVER ili9806e_dsi_vdo_hlt_fwvga_oncell_lcm_drv = 
{
    .name			= "ili9806e_dsi_vdo_hlt_fwvga_oncell",
