...
static unsigned int lcm_esd_recover(void)
{
	...
	#ifndef BUILD_LK
	printk("lcm_esd_recover  ili9806e_dsi_vdo_djn_fwvga \n");
	#endif
	return TRUE;
}
...
LCM_DRIVER ili9806e_dsi_vdo_djn_fwvga_lcm_drv = 
{
    .name			= "ili9806e_dsi_vdo_djn_fwvga",
