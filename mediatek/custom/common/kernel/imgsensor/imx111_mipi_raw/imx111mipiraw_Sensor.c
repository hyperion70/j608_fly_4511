...
#define IMX111_TEST_PATTERN_CHECKSUM (0x9657b9f1)
...
MSDK_SCENARIO_ID_ENUM IMX111MIPI_CurrentScenarioId = MSDK_SCENARIO_ID_CAMERA_PREVIEW;
...
static void IMX111MIPI_Sensor_Init(void)
{
	...
	IMX111MIPI_write_cmos_sensor(0x0101, 0x03);//zc 03 -->00 flip 180
...
void IMX111MIPI_VideoFullSizeSetting(void)//16:9   6M
...
void IMX111MIPI_PreviewSetting(void)
	{	
                                                ...
                                                MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	...
	SENSORDB("shutter&gain test by hhl: enter the video function IMX111MIPIPreview\n"); 
		...
		IMX111MIPI_sensor.capture_mode=KAL_FALSE;
		spin_unlock(&imx111_drv_lock);
		IMX111MIPI_VideoFullSizeSetting();
...
UINT32 IMX111MIPIGetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution)
{
    ...
    pSensorResolution->SensorPreviewHeight	= IMX111MIPI_REAL_PV_HEIGHT-120;
    pSensorResolution->SensorFullWidth		= IMX111MIPI_REAL_CAP_WIDTH;
    pSensorResolution->SensorFullHeight		= IMX111MIPI_REAL_CAP_HEIGHT;
    pSensorResolution->SensorVideoWidth		= IMX111MIPI_REAL_PV_WIDTH;//IMX111MIPI_REAL_VIDEO_WIDTH;
...
//    pSensorInfo->SensorWebCamCaptureFrameRate=22;//hhl 2-28
    ...
    pSensorInfo->SensorOutputDataFormat=SENSOR_OUTPUT_FORMAT_RAW_R;//zc flip 180 SENSOR_OUTPUT_FORMAT_RAW_B--> SENSOR_OUTPUT_FORMAT_RAW_R
...
{
		spin_lock(&imx111_drv_lock);	
		IMX111MIPI_CurrentScenarioId = ScenarioId;
		spin_unlock(&imx111_drv_lock);
    switch (ScenarioId)
    {
        case MSDK_SCENARIO_ID_CAMERA_PREVIEW:
                                                                ...
                                                                UINT8 *pFeaturePara,UINT32 *pFeatureParaLen)
{
    ...
    switch (FeatureId)
    {
        ...
        case SENSOR_FEATURE_GET_PERIOD:
        		switch(IMX111MIPI_CurrentScenarioId)
        		{
        			case MSDK_SCENARIO_ID_CAMERA_ZSD:
        		    case MSDK_SCENARIO_ID_CAMERA_CAPTURE_JPEG:
