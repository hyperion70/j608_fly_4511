...
void GC0312_Sensor_Init(void)
{
	...
	GC0312_write_cmos_sensor(0x24, 0x3f);//16
...
BOOL GC0312_set_param_wb(UINT16 para)
{
	...
	switch (para)
	{
		...
		case AWB_MODE_CLOUDY_DAYLIGHT: //cloudy
			...
			GC0312_write_cmos_sensor(0x77, 0x68); //WB_manual_gain 
			GC0312_write_cmos_sensor(0x78, 0x30);///50
			GC0312_write_cmos_sensor(0x79, 0x3c);
		break;
		
		case AWB_MODE_DAYLIGHT: //sunny
			GC0312_awb_enable(KAL_FALSE);
			GC0312_write_cmos_sensor(0x77, 0x70); ///b0   62
			GC0312_write_cmos_sensor(0x78, 0x36);///52
			GC0312_write_cmos_sensor(0x79, 0x3c);			
		break;
		
		case AWB_MODE_INCANDESCENT: //office/////baichideng
			GC0312_awb_enable(KAL_FALSE);
			GC0312_write_cmos_sensor(0x77, 0x56);//////48
			GC0312_write_cmos_sensor(0x78, 0x40);
			GC0312_write_cmos_sensor(0x79, 0x7c);//5c
		break;
		...
		case AWB_MODE_FLUORESCENT:///////yingguangdeng
			GC0312_awb_enable(KAL_FALSE);
			GC0312_write_cmos_sensor(0x77, 0x50);///40
			GC0312_write_cmos_sensor(0x78, 0x50);//42
			GC0312_write_cmos_sensor(0x79, 0x64);//50
		break;
