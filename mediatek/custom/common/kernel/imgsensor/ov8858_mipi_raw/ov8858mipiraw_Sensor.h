...
typedef struct
{
	...
	#define OV8858_VIDEO_PCLK 				(72000000)
	#define OV8858_CAPTURE_PCLK 			(72000000)
	...
	#define OV8858_IMAGE_SENSOR_VIDEO_WIDTH 				(1632)
	#define OV8858_IMAGE_SENSOR_VIDEO_HEIGHT				(1224)
...
//TODO~
	...
	#define OV8858_PV_PERIOD_LINE_NUMS					(1244)

	#define OV8858_VIDEO_PERIOD_PIXEL_NUMS				(1928)
	#define OV8858_VIDEO_PERIOD_LINE_NUMS				(1244)

	#define OV8858_FULL_PERIOD_PIXEL_NUMS				(1940)
	#define OV8858_FULL_PERIOD_LINE_NUMS				(2474)
	
	#define OV8858MIPI_WRITE_ID 	(0x42)
	#define OV8858MIPI_READ_ID	(0x43)
