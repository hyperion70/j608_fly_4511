...
HI257WriteCmosSensor(0x40, 0x01); 
...
//Normal BLC
HI257WriteCmosSensor(0xa8, 0x48); //R,Gr,B,Gb Offset
///// PAGE 0 END /////
...
HI257WriteCmosSensor(0x10, 0x03); //S2D enable _ YUYV Order 痕井
...
HI257WriteCmosSensor(0x48, 0x85);
...
HI257WriteCmosSensor(0x67, 0x23);

HI257WriteCmosSensor(0x6a, 0x58); //White Protection Offset Dark/Indoor
HI257WriteCmosSensor(0x74, 0x0c); //White Protection Offset Outdoor
...
HI257WriteCmosSensor(0x80, 0xfd); //Sharp2D enable _ YUYV Order 痕井
...
//Sharp Lclp
HI257WriteCmosSensor(0xa2, 0x02); //Outdoor Lclip_N
HI257WriteCmosSensor(0xa3, 0x03); //Outdoor Lclip_P
...
//Outdoor Slope
HI257WriteCmosSensor(0xb6, 0x30); //Lum negative Hi
HI257WriteCmosSensor(0xb7, 0x46); //Lum negative middle
HI257WriteCmosSensor(0xb8, 0x46); //Lum negative Low
HI257WriteCmosSensor(0xb9, 0x2d); //Lum postive Hi
HI257WriteCmosSensor(0xba, 0x2a); //Lum postive middle
HI257WriteCmosSensor(0xbb, 0x42); //Lum postive Low

//Indoor Slope
HI257WriteCmosSensor(0xbc, 0x38); //Lum negative Hi
HI257WriteCmosSensor(0xbd, 0x30); //Lum negative middle
HI257WriteCmosSensor(0xbe, 0x34); //Lum negative Low
HI257WriteCmosSensor(0xbf, 0x38); //Lum postive Hi
HI257WriteCmosSensor(0xc0, 0x30); //Lum postive middle
HI257WriteCmosSensor(0xc1, 0x34); //Lum postive Low
...
HI257WriteCmosSensor(0x20, 0x65); //X-Center
HI257WriteCmosSensor(0x21, 0x70); //Y-Center

HI257WriteCmosSensor(0x22, 0x25); //LSC R 1b->15 20130125
...
HI257WriteCmosSensor(0x18, 0x8e);// Double_AG 5e->37
HI257WriteCmosSensor(0x19, 0x8d);// Double_AG 5e->36
...
HI257WriteCmosSensor(0x51, 0x17);
HI257WriteCmosSensor(0x52, 0x23);
HI257WriteCmosSensor(0x53, 0x36);
HI257WriteCmosSensor(0x54, 0x56);
HI257WriteCmosSensor(0x55, 0x70);
HI257WriteCmosSensor(0x56, 0x87);
HI257WriteCmosSensor(0x57, 0x9a);
HI257WriteCmosSensor(0x58, 0xab);
HI257WriteCmosSensor(0x59, 0xba);
HI257WriteCmosSensor(0x5a, 0xc7);
HI257WriteCmosSensor(0x5b, 0xd2);
HI257WriteCmosSensor(0x5c, 0xdc);
HI257WriteCmosSensor(0x5d, 0xe4);
HI257WriteCmosSensor(0x5e, 0xeb);
HI257WriteCmosSensor(0x5f, 0xf1);
HI257WriteCmosSensor(0x60, 0xf7);
HI257WriteCmosSensor(0x61, 0xfb);
...
HI257WriteCmosSensor(0x1f, 0x3e); //mcmc_sat_gain2
HI257WriteCmosSensor(0x20, 0x4b); //mcmc_sat_gain3
HI257WriteCmosSensor(0x21, 0x52); //mcmc_sat_gain4
HI257WriteCmosSensor(0x22, 0x59); //mcmc_sat_gain5
HI257WriteCmosSensor(0x23, 0x46); //mcmc_sat_gain6
HI257WriteCmosSensor(0x24, 0x00); //mcmc_hue_angle1
HI257WriteCmosSensor(0x25, 0x01); //mcmc_hue_angle2
...
HI257WriteCmosSensor(0x70, 0x45); //6c
...
HI257WriteCmosSensor(0x86, 0x01); //EXPMin 6000.00 fps
HI257WriteCmosSensor(0x87, 0xf4); 

HI257WriteCmosSensor(0x88, 0x0c); //EXP Max(120Hz) 8.00 fps 
HI257WriteCmosSensor(0x89, 0x5c); 
HI257WriteCmosSensor(0x8a, 0x10); 

HI257WriteCmosSensor(0xa5, 0x0b); //EXP Max(100Hz) 8.33 fps   
HI257WriteCmosSensor(0xa6, 0xe6); 
HI257WriteCmosSensor(0xa7, 0xe0);  
...
HI257WriteCmosSensor(0x9c, 0x0f); //EXP Limit 1500.00 fps 
HI257WriteCmosSensor(0x9d, 0xa0); 
HI257WriteCmosSensor(0x9e, 0x01); //EXP Unit 
HI257WriteCmosSensor(0x9f, 0xf4); 

HI257WriteCmosSensor(0xa3, 0x00); 
HI257WriteCmosSensor(0xa4, 0xfd); //EXP 12000 
...
HI257WriteCmosSensor(0x41, 0x32); //Stb cdiff
...
HI257WriteCmosSensor(0x87, 0x42);
HI257WriteCmosSensor(0x88, 0x2a);
HI257WriteCmosSensor(0x89, 0x2c);
HI257WriteCmosSensor(0x8a, 0x18);

HI257WriteCmosSensor(0x8b, 0x3d);
HI257WriteCmosSensor(0x8c, 0x2a);
HI257WriteCmosSensor(0x8d, 0x2c);
...
HI257WriteCmosSensor(0x03, 0x00); //Page 0
HI257WriteCmosSensor(0x11, 0x90);  // Fixed frame rate ON
HI257WriteCmosSensor(0x03, 0x20);
HI257WriteCmosSensor(0x10, 0x1c);
...
HI257WriteCmosSensor(0x83, 0x09); //EXP Normal(100Hz) 10.00 fps
...
HI257WriteCmosSensor(0x03, 0x00);
HI257WriteCmosSensor(0x10, 0x11);
HI257WriteCmosSensor(0x90, 0x0c); //BLC_TIME_TH_ON
HI257WriteCmosSensor(0x91, 0x0c); //BLC_TIME_TH_OFF
HI257WriteCmosSensor(0x92, 0xe8); //BLC_AG_TH_ON
HI257WriteCmosSensor(0x93, 0xe0); //BLC_AG_TH_OFF
...
HI257SetAwbMode(KAL_FALSE); 
HI257WriteCmosSensor(0x80, 0x45); 
HI257WriteCmosSensor(0x81, 0x20);
HI257WriteCmosSensor(0x82, 0x27);
...
HI257SetAwbMode(KAL_FALSE); 
HI257WriteCmosSensor(0x80, 0x33); 
HI257WriteCmosSensor(0x81, 0x20);
HI257WriteCmosSensor(0x82, 0x3d); 
...
HI257WriteCmosSensor(0x81, 0x20);
HI257WriteCmosSensor(0x82, 0x44); 
...
HI257WriteCmosSensor(0x80, 0x45); 
HI257WriteCmosSensor(0x81, 0x20);
HI257WriteCmosSensor(0x82, 0x2f); 
...
void HI257set_saturation(UINT16 para)
{
	...
	//HI257WriteCmosSensor(0x03, 0x10);
	//HI257WriteCmosSensor(0x61, 0x98); //Sat B
	//HI257WriteCmosSensor(0x62, 0x98); // SATR
             break;
    }
     return;
}
...
HI257WriteCmosSensor(0x88, 0x0b); //EXP Max(120Hz) 8.57 fps 
HI257WriteCmosSensor(0x89, 0xe6); 
HI257WriteCmosSensor(0x8a, 0xe0); 

HI257WriteCmosSensor(0xa5, 0x0b); //EXP Max(100Hz) 8.33 fps 
HI257WriteCmosSensor(0xa6, 0xe6); 
HI257WriteCmosSensor(0xa7, 0xe0); 

HI257WriteCmosSensor(0x91, 0x06);  //EXP Fix 8.00 fps
HI257WriteCmosSensor(0x92, 0x32); 
HI257WriteCmosSensor(0x93, 0xea); 
HI257WriteCmosSensor(0x01, 0x00);
...
HI257WriteCmosSensor(0x89, 0xf3); 
HI257WriteCmosSensor(0x8a, 0x70); 

HI257WriteCmosSensor(0xa5, 0x05); //EXP Max(100Hz) 16.67 fps 
HI257WriteCmosSensor(0xa6, 0xf3); 
HI257WriteCmosSensor(0xa7, 0x70); 

HI257WriteCmosSensor(0x91, 0x03);  //EXP Fix 16.01 fps
HI257WriteCmosSensor(0x92, 0x18); 
HI257WriteCmosSensor(0x93, 0xf8); 
HI257WriteCmosSensor(0x01, 0x00);
