...
#include "gc2235mipi_Camera_Sensor_para.h"
#include "gc2235mipi_CameraCustomized.h"
...
static GC2235MIPI_sensor_struct GC2235MIPI_sensor =
{
	...
	.Mirror = GC2235MIPI_IMAGE_NORMAL,//GC2235MIPI_IMAGE_HV_MIRROR, // zc GC2235MIPI_IMAGE_V_MIRROR,-->GC2235MIPI_IMAGE_NORMAL-->GC2235MIPI_IMAGE_H_MIRROR
	.shutter = 0x20,  
	.gain = 0x20,
...
static void GC2235MIPI_camera_para_to_sensor(void)
{
  kal_uint32 i;
#ifdef GC2235MIPI_DRIVER_TRACE
	 SENSORDB("wkp GC2235MIPI_camera_para_to_sensor\n");
#endif
...
#ifdef GC2235MIPI_DRIVER_TRACE
   SENSORDB("wkp GC2235MIPI_sensor_to_camera_para\n");
#endif
  for (i = 0; 0xFFFFFFFF != GC2235MIPI_sensor.eng.reg[i].Addr; i++)
  {
...
static void GC2235MIPI_Sensor_Init(void)
{
...
#ifdef GC2235_MIPI_2_Lane
	GC2235MIPI_write_cmos_sensor(0x1b, 0x4b);
#else
	...
	GC2235MIPI_write_cmos_sensor(0x6a, 0x03);
	GC2235MIPI_write_cmos_sensor(0x6b, 0x03); 
	GC2235MIPI_write_cmos_sensor(0x6c, 0x03);
	GC2235MIPI_write_cmos_sensor(0x6d, 0x03); 
	GC2235MIPI_write_cmos_sensor(0x6e, 0x03);
	GC2235MIPI_write_cmos_sensor(0x6f, 0x03);
	GC2235MIPI_write_cmos_sensor(0x70, 0x03);
	GC2235MIPI_write_cmos_sensor(0x71, 0x03); 
	Sleep(100);
	...
	GC2235MIPI_write_cmos_sensor(0x22, 0x02);
	GC2235MIPI_write_cmos_sensor(0x23, 0x01);
	GC2235MIPI_write_cmos_sensor(0x29, 0x02);
	GC2235MIPI_write_cmos_sensor(0x2a, 0x01);
#ifdef GC2235_MIPI_2_Lane
...
UINT32 GC2235MIPIOpen(void)
{
	...
	SENSORDB("wkp GC2235MIPIOpen, sensor_id:%x \n",sensor_id);
