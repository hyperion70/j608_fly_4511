...
BOOL SP0A19_set_param_wb(UINT16 para)
{
	...
	{            
		...
		case AWB_MODE_DAYLIGHT:
			...
			SP0A19_write_cmos_sensor(0x32,0x05);                                                          
			SP0A19_write_cmos_sensor(0xfd,0x01);                                                          
			SP0A19_write_cmos_sensor(0x28,0xd0);//0xbc		                                                       
			SP0A19_write_cmos_sensor(0x29,0x9d);//0x5d		                                                       
			SP0A19_write_cmos_sensor(0xfd,0x00); 
		    break;
		case AWB_MODE_INCANDESCENT:	
			...
			SP0A19_write_cmos_sensor(0x32,0x05);                                                          
			SP0A19_write_cmos_sensor(0xfd,0x01);                                                          
			SP0A19_write_cmos_sensor(0x28,0xbc);//0x89		                                                       
			SP0A19_write_cmos_sensor(0x29,0xdd);//0xb8		                                                       
			SP0A19_write_cmos_sensor(0xfd,0x00); 
		    break;  
		case AWB_MODE_FLUORESCENT:
			...
			SP0A19_write_cmos_sensor(0x32,0x05);                                                          
			SP0A19_write_cmos_sensor(0xfd,0x01);                                                          
			SP0A19_write_cmos_sensor(0x28,0xd8);//0xb5		                                                       
		...
		case AWB_MODE_TUNGSTEN:
			...
			SP0A19_write_cmos_sensor(0x32,0x05);                                                          
			SP0A19_write_cmos_sensor(0xfd,0x01);                                                          
			SP0A19_write_cmos_sensor(0x28,0xf8);//0xaf		                                                       
			SP0A19_write_cmos_sensor(0x29,0x80);//0x99		                                                       
			SP0A19_write_cmos_sensor(0xfd,0x00);  
		    break;
		default:
			return KAL_FALSE;
