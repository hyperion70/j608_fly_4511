 ...
 */
/*
+++++rgk back to old code ,nothing to change by anxiang.xiao 20140331
*/
...
/*----------------------------------------------------------------------------*/
int kxtik1004_gsensor_operate(void* self, uint32_t command, void* buff_in, int size_in,
...
static int kxtik1004_i2c_probe(struct i2c_client *client, const struct i2c_device_id *id)
{
	...
	sobj.self = obj;
    sobj.polling = 1;
    sobj.sensor_operate = kxtik1004_gsensor_operate;
