...
static int bma222_init_flag =-1; // 0<==>OK -1 <==> fail
...
static int BMA222_ReadSensorData(struct i2c_client *client, char *buf, int bufsize)
{
	...
	{
		//+++rgk anxiang.xiao add somelog 20140412
		//GSE_LOG("raw data x=%d, y=%d, z=%d \n",obj->data[BMA222_AXIS_X],obj->data[BMA222_AXIS_Y],obj->data[BMA222_AXIS_Z]);
		//printk("\n&&&& line:%d ,cali_sw[BMA222_AXIS_X] : %d, cali_sw[BMA222_AXIS_X] : %d, cali_sw[BMA222_AXIS_X] : %d&&&&&&\n",__LINE__, obj->cali_sw[BMA222_AXIS_X],obj->cali_sw[BMA222_AXIS_Y],obj->cali_sw[BMA222_AXIS_Z]);
		//printk("\n&&&& line:%d, obj->data[BMA222_AXIS_X]: %d, obj->data[BMA222_AXIS_Y]: %d, obj->data[BMA222_AXIS_Z] : %d&&&&&&\n",__LINE__,obj->data[BMA222_AXIS_X],obj->data[BMA222_AXIS_Y],obj->data[BMA222_AXIS_Z]);
		...
		//Out put the mg
		//printk("line:%d,mg acc_x=%d, acc_y=%d, acc_z=%d, GRAVITY=%d, sensityvity=%d \n",__LINE__,acc[BMA222_AXIS_X],acc[BMA222_AXIS_Y],acc[BMA222_AXIS_Z],GRAVITY_EARTH_1000,obj->reso->sensitivity);
