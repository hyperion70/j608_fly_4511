...
//modify
static const struct i2c_device_id mxc622x_i2c_id[] = {{MXC622X_DEV_NAME,0},{}}; /* 该名称必须与BOARD_INFO的匹配才会调用probe函数 */
...
/*----------------------------------------------------------------------------*/
//static int mxc622x_ioctl(struct inode *inode, struct file *file, unsigned int cmd, unsigned long arg)
static int mxc622x_unlocked_ioctl(struct file *file, unsigned int cmd, unsigned long arg)
{
