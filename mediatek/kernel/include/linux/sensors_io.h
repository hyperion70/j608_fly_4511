...
/*-------------------[jing.zhao@qingcheng.com] add-------------------------------------------*/
#define ALSPS_SET_GESTURE_MODE					_IOW(ALSPS, 0x14, int)
#define ALSPS_GET_GESTURE_MODE					_IOR(ALSPS, 0x15, int)
#define ALSPS_GET_GESTURE_DATA					_IOR(ALSPS, 0x16, int)
...
#define MHALL								0X88					//++++rgk bug_id:  add by jiangwanwei 140529++++
#define MHALL_IOCTL_GET_STATUS				_IOR(MHALL, 0x01, int)	//++++rgk bug_id:  add by jiangwanwei 140529++++
