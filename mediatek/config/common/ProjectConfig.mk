...
#zhangyuwen modify BOOT_LOGO 20140425
#BOOT_LOGO=j608_xolo
BOOT_LOGO=cu_wvga
...
RGK_SALES_SUPPORT = no
#BUG_ID:JWLW-58 add OTA and Sales liangyulong  end

#A: JWLWKK-175 daizhiyi {
RGK_MEDIATEK_BINARY_82_KK_SUPPORT = no
RGK_MEDIATEK_BINARY_82_TD_SUPPORT = no
RGK_MEDIATEK_BINARY_92_KK_SUPPORT = no
RGK_MEDIATEK_BINARY_92_TD_SUPPORT = no
#A: }
...
RGK_USB_DRIVER_DISPLAY_PRODUCT_PART1 =
...
RGK_FAKE_SIGNAL_SUPPORT = yes
#add BUG_ID:DLEL-358 chenweihua 20130809 (end)

#add by jinhaijian for serial form barcode {
SERIAL_NUM_FROM_BARCODE = yes
#add by jinhaijian for serial form barcode }

#add bug_id:none zengchuiguo 20140529 (start)
#It will lead to the systemimage larger than 700MB and fail upgrade from android 4.2 to 4.4 if export apk odex.
#Set it to no if the project need to support upgrade from 4.2 to 4.4 
RGK_EXPORT_ODEX = yes
#add bug_id:none zengchuiguo 20140529 (end)

#A: BUG_ID:none tianchunming 20140529 {
RGK_FOR_PLAYSTORE_ISSUE=no
#A: }
...
#A: JWYY-1013 daizhiyi 20140806 {
#Remove Home screen tips
RGK_REMOVE_PROTIPS_SUPPORT = no
#A: }

#A: JLLB-2938 guochenlong  20140804
RGK_FEATURE_NATIONAL_ROAMING = no

#add bug_id:JLLB-3649 zengchuiguo 20140807 (start)
#This macro decides whether the ro.build.version.incremental shows the build user. If it is yes it will be "user.$(DATE_INFO)", otherwise it will be "user.$(USER).$(DATE_INFO)".
RGK_BUILD_NUMBER_WITHOUT_BUILD_USER = no
#add bug_id:JLLB-3649 zengchuiguo 20140807 (start)

#A: JWLWKK-1931 daizhiyi 21040809 {
RGK_CUSTOM_TONE = 
#A: }

#A: JWLWKK-1120 zyn  20140811 {
RGK_FEATURE_FILEMANAGER_SUPPORT = no
#A }

#add JWLWKK-1938 niujunwei 20140812 start
RGK_CALL_LOG_FILTER_ADD_ICON_SUPPORT = no
#add JWLWKK-1938 niujunwei 20140812 end

#add JWYY-636 niujunwei 20140813 start
RGK_SND_SORT_SUPPORT = no
