...
CUSTOM_HAL_SUB_IMGSENSOR=ov2685_yuv sp2529_yuv
...
CUSTOM_KERNEL_IMGSENSOR= ov2685_yuv sp2529_yuv imx135_mipi_raw
...
CUSTOM_KERNEL_LENS=dummy_lens  bu6424af
...
CUSTOM_KERNEL_MHALL=sense_level	#och165twad #++++rgk bug_id: none add by jiangwanwei 140303 end++++
RGK_MHALL_OCH165_SUPPORT=yes
...
CUSTOM_KERNEL_SUB_IMGSENSOR=ov2685_yuv sp2529_yuv

# lens driver config for video telephony camera
CUSTOM_KERNEL_SUB_LENS=dummy_lens

# touch driver  need to report correct touch axes
CUSTOM_KERNEL_TOUCHPANEL= FT5336 GT9XX_3 #GT9XX jww S7020 GT9XX
...
CUSTOM_LK_LCM=otm1283a_dsi_vdo_trust_hd720_ips hx8394_dsi_vdo_truly_hd720_ips #jww hx8394a_hd720_dsi_vdo_tianma
...
# Add these variables to define the default input method and default input method languages.
DEFAULT_LATIN_IME_LANGUAGES=en-US ru uk
...
# M:JLLB-1273 qinzhaojin modify "yes" to "no" (start)
MTK_AUDIO_DDPLUS_SUPPORT=no
# M:JLLB-1273 qinzhaojin modify "yes" to "no" (end)
...
# modify bug:JWYY-88 by zyn 20140421
# M:JLLB-1333 qinzhaojin modify "yes" to "no" (start)
MTK_DATA_TRANSFER_APP=no
# M:JLLB-1333 qinzhaojin modify "yes" to "no" (end)
...
MTK_FAN5405_SUPPORT=no #jww yes
...
#modify BUG_ID:JBLW-1054 tianchunming (start)
# Let persist.sys.usb.config in default.prop as mass_storage.
#MTK_MASS_STORAGE=yes
MTK_MASS_STORAGE=no
#modify BUG_ID:JBLW-1054 tianchunming (end)
...
#zhangyuwen modify MTK_OOBE_APP to no 20140428
#MTK_OOBE_APP=yes
MTK_OOBE_APP=no
...
CUSTOM_MODEM=sky77590_gsm4_w1258_j608_hspa_gemini
...
CUSTOM_KERNEL_LCM=otm1283a_dsi_vdo_trust_hd720_ips hx8394_dsi_vdo_truly_hd720_ips #jww hx8394a_hd720_dsi_vdo_tianma

# To choose uboot LCM driver name
CUSTOM_UBOOT_LCM=otm1283a_dsi_vdo_trust_hd720_ips hx8394_dsi_vdo_truly_hd720_ips #jww hx8394a_hd720_dsi_vdo_tianma

# To set LCM resolution height size
LCM_HEIGHT=1280 #jww 1280

# To set LCM resolution width size
LCM_WIDTH=720 #jww 720
...
MTK_PRODUCT_LOCALES=ru_RU en_US uk_UA
...
#A: JWLWKK-175 daizhiyi {
RGK_MEDIATEK_BINARY_92_KK_SUPPORT = yes
#A: }

#modify BUG_ID:DELQ-183 zengchuiguo 20140513 (start)
RGK_INTERNAL_SD_VOLUME_NAME = IQ4511^Octa
RGK_MTP_LABEL = IQ4511 Octa
RGK_PTP_LABEL = IQ4511 Octa
#modify BUG_ID:DELQ-183 zengchuiguo 20140513 (end)

#modify BUG_ID:JWLW-1205 zengchuiguo 20140125 (start)
RGK_USB_DRIVER_DISPLAY_MANUFACTURER =IQ4511
...
RGK_USB_DRIVER_DISPLAY_PRODUCT_PART1 = Octa
...
RGK_FLY_MATCH_NUMBER_SUPPORT = yes
...
#add BUG_ID:JWYY-201  dingzhaolei 20140429(start)
RGK_CALENDAR_SUPPORT = yes
#add BUG_ID:JWYY-201 dingzhaolei 20140429(end)

#add BUG_ID:JWLJ-141 qinzhaojin 20140408(start)
RGK_HIDE_DAYDREAM = yes
#add BUG_ID:JWLJ-141 qinzhaojin 20140408(end)

#add BUG_ID:JWLJ-296 qianyadong 20140409(start)
RGK_DEFAULT_MYCARRIER = yes
#add BUG_ID:JWLJ-296 qianyadong 20140409(end)

#add BUG ID:JWLJ-297 chenshu 20140418 (start)
RGK_ENABLE_VCALENDAR = no
#add BUG ID:JWLJ-297 chenshu 20140418 (end)

#add BUG_ID:JLLB-1270 qinzhaojin 20140630 (start)
RGK_SHOW_USER2ROOT = no
#add BUG_ID:JLLB-1270 qinzhaojin 20140630 (end) 

# add by jinhaijian for serial for bar code {
SERIAL_NUM_FROM_BARCODE = yes
# add by jinhaijian for serial for bar code }

# add by wuhao
RGK_TOUCHPANEL_GESTURE = yes

#add by wuhao only for j608 to resolve charger disturb touchpanel 
RGK_CHARGER_DISTURB_TOUCHPANEL=yes

#add BUG_ID:JLLB-1332 qinzhaojin 20140702 (start)
RGK_TODOS_SUPPORT = no
#add BUG_ID:JLLB-1332 qinzhaojin  20140702 (end)
#add by liuxianbang for JLLB-1938 (start)
RGK_ADB_RSA_SUPPORT = yes
#add by liuxianbang for JLLB-1938 (end)

#add xieshanlin  20140619(start)
RGK_GESTURE_WAKE=yes
#add xieshanlin  20140619(end)

#add JLLB-2514 yejianming 20140725 start
RGK_MUSIC_SUPPORT=no
#add JLLB-2514 yejianming 20140725 end
#A: bug_id:JLLB-2655 tianchunming 20140729 for white signal icons {
RGK_CTS_WHITE_SIGNAL_ICONS_SUPPORT = yes
#A: }

#add huruilong jllb-2597
#very very important:  it just add for j608_fly, other project must delete it immediately
RGK_FRONT_CAMERA_VALUES_FOR_FLY=yes
#end 
