...
void mt_usb_set_vbus(struct musb *musb, int is_on)
{
    ...
    #elif defined(MTK_NCP1851_SUPPORT) || defined(MTK_BQ24196_SUPPORT) || defined(MTK_BQ24296_SUPPORT)
...
{
#ifdef ID_PIN_USE_EX_EINT
#ifdef GPIO_OTG_IDDIG_EINT_PIN_M_IDDIG
	mt_set_gpio_mode(GPIO_OTG_IDDIG_EINT_PIN, GPIO_OTG_IDDIG_EINT_PIN_M_IDDIG);
#else
    mt_set_gpio_mode(GPIO_OTG_IDDIG_EINT_PIN, GPIO_OTG_IDDIG_EINT_PIN_M_EINT);
#endif
