...
#ifdef GPIO_MSDC1_INSI//lisong 2013-11-25 [BUGID NULL][sdcard support hotplug]start
        mt_set_gpio_mode(GPIO_MSDC1_INSI, GPIO_MSDC1_INSI_M_EINT);
        mt_set_gpio_dir(GPIO_MSDC1_INSI, GPIO_DIR_IN);
        mt_set_gpio_pull_enable(GPIO_MSDC1_INSI, GPIO_PULL_ENABLE);
        mt_set_gpio_pull_select(GPIO_MSDC1_INSI, GPIO_PULL_UP);
#endif //lisong 2013-11-25 [BUGID NULL][sdcard support hotplug]end 
