...
//++++rgk bug_id: none add by jiangwanwei 140303 start++++
struct platform_device sensor_mhall = {
	.name          = "mhall",
	.id            = -1,
};
//++++rgk bug_id: none add by jiangwanwei 140303 end++++
...
__init int mt_board_init(void)
{
	...
	rgk_creat_proc_mem_info();	//++++rgk bug_id: none add by jiangwanwei 140312++++
...
//++++rgk bug_id: none add by jiangwanwei 140303 start++++
#if defined(CUSTOM_KERNEL_MHALL)
