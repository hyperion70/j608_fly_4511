...
# penny add for mt6592 customer begin
my $ptgen_sheet_customer_location;
# penny add for mt6592 customer end
...
sub InitGlobalValue
{
    ...
    {
        # penny add for mt6592 customer
        $ptgen_sheet_customer_location = "mediatek/config/$ArgList{PROJECT}/partition_table_$ArgList{PLATFORM}.xls";
    		
        if(-e $ptgen_sheet_customer_location)
        {
        	$Partition_layout_xls = $ptgen_sheet_customer_location;
        	print "penny add ptgen excel address: $Partition_layout_xls ";
        }
        else
        {    
