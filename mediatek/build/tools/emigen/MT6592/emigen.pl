...
sub custom_EMI_c_file_body
{
    ...
    my $ddr = -1 ;
    my $RGK_MEM_NAME = "" ;				#++++rgk bug_id: none add by jiangwanwei 140312++++
...
#++++rgk bug_id:  add by jiangwanwei 140312 start++++
			$RGK_MEM_NAME = $RGK_MEM_NAME . "\"";
			$RGK_MEM_NAME = $RGK_MEM_NAME . $CustCS_PART_NUMBER[$iter];
			$RGK_MEM_NAME = $RGK_MEM_NAME . "\"";
			$RGK_MEM_NAME = $RGK_MEM_NAME . ",";
#++++rgk bug_id:  add by jiangwanwei 140312 end++++
	}
    }
    for $iter (0..$TotalCustemChips-1)
    {
...
//++++rgk bug_id:  add by jiangwanwei 140126 end++++
