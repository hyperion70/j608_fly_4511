...
extern int replace_character(const char ** str, const char *rchar, const char *dchar );
...
static int android_bind(struct usb_composite_dev *cdev)
{
	...
	strncpy(manufacturer_string, MANUFACTURER_STRING, sizeof(manufacturer_string) - 1);
#endif
//modify bug_id:DLEY-218 zengchuiguo 20140213 (start)
/*
#ifdef RGK_USB_DRIVER_DISPLAY_PRODUCT
	strncpy(product_string, RGK_USB_DRIVER_DISPLAY_PRODUCT, sizeof(product_string) - 1);
*/
#ifdef RGK_USB_DRIVER_DISPLAY_PRODUCT_PART1
	#ifdef RGK_USB_DRIVER_DISPLAY_PRODUCT_PART2
		snprintf(product_string,MASS_STORAGE_PRODUCT_VALUE,"%s %s %s",manufacturer_string,RGK_USB_DRIVER_DISPLAY_PRODUCT_PART1, RGK_USB_DRIVER_DISPLAY_PRODUCT_PART2);
	#else
		snprintf(product_string,MASS_STORAGE_PRODUCT_VALUE,"%s %s",manufacturer_string,RGK_USB_DRIVER_DISPLAY_PRODUCT_PART1);
	#endif
//modify bug_id:DLEY-218 zengchuiguo 20140213 (end)
